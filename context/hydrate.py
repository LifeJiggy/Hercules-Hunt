#!/usr/bin/env python3
"""context/hydrate.py — Load ALL .md files in this folder for context.

Usage:
    python context/hydrate.py [--load | --count | --list | --search <term> | --tree]
">
import json
import os
import sys
