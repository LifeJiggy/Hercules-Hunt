#!/usr/bin/env python3
"""recon/hydrate.py — Load ALL .md files in this folder for context.

Usage:
    python recon/hydrate.py [--load | --count | --list | --search <term> | --tree]
">
import json
import os
import sys
...
MODULE_NAME = recon.name


def get_all_md_files():
    return sorted(recon.glob("*.md"))
